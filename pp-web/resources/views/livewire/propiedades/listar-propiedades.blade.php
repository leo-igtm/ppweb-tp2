            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">Gestión de Propiedades</h2>
                    ...
                    <div class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            <select wire:model.live="operacionFilter" 
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            <select wire:model.live="disponibleFilter" 
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                            ...
                                            <div class="flex space-x-2">
                                                ...
                                                @if(auth()->user()->isAdmin() || (auth()->user()->isAgente() && $propiedad->agente_id === auth()->id()))
                                                    ...
                                                    <button wire:click="eliminar({{ $propiedad->id }})" 
                                                            wire:confirm="¿Estás seguro de eliminar esta propiedad?"
