...
2. Desde la home, navegar con el menú superior.
3. Si no tienes sesión, usar **Login** o **Registrarse**.

### 2) Navegación general
1. **Inicio**: muestra el hero principal, propiedades destacadas y servicios.
2. **Propiedades**: lista todas las propiedades disponibles.
3. **Servicios**: muestra los servicios de la inmobiliaria.
4. **Contacto**: permite enviar mensajes al equipo.

### 3) Uso según rol
1. **Administrador**: administra propiedades, usuarios y estadísticas.
2. **Gerente**: revisa el panel, edita propiedades y gestiona permisos por rol.
3. **Agente**: crea y edita sus propias propiedades.
4. **Cliente**: solo visualiza propiedades y detalles.

### 4) Gestión de propiedades
1. Entrar a **Propiedades** o al panel del rol.
2. Usar **Ver** para abrir el detalle.
3. Usar **Editar** para modificar datos permitidos.
4. Usar **Nueva Propiedad** para registrar una nueva publicación.
5. Subir imagen desde el formulario si se desea.

### 5) Permisos por rol
1. Entrar como **Gerente**.
2. Abrir **Ver permisos por rol**.
3. Activar o desactivar permisos de admin, gerente y agente.
4. Guardar cambios para que queden persistidos.

### 6) Reglas importantes
1. Los cambios de permisos afectan el acceso inmediato de cada rol.
2. El botón **Editar** de propiedades lleva a una página Inertia.
3. Las imágenes se cargan desde `public/icon/inmobiliaria.png` en la marca y home.
4. El diseño general usa modo oscuro con transparencias.
